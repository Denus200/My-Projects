...
from overlord.domain.projects import Project, ProjectStatus, require_project_title
from overlord.domain.tasks import TaskLifecycle, require_task_title, validate_estimate, week_start

from .common import ProjectDetail, UnitOfWorkFactory
        ...
        *,
        ...
        with self.uow_factory() as uow:
            ...
            if clean_task:
                ...
                uow.tasks.assign_plan(task.id, chosen_date, None, None, week_start(chosen_date, first_day))
            return project

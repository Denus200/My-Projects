...
from overlord.modules.planning.domain import TodayGroup, validate_slot, week_start
        ...
        *,
        ...
        with self.uow_factory() as uow:
            ...
            if chosen_date is not None:
                ...
                uow.planning.assign_plan(task.id, chosen_date, today_group, position, week_start(chosen_date, first_day))
...
class AssignTaskPlan:
    ...
    def execute(
        ...
        with self.uow_factory() as uow:
            ...
            first_day = 6 if uow.settings.get().first_day_of_week == "sunday" else 0
            return uow.planning.assign_plan(
    ...
    def execute(self, task_id: int) -> TaskEditorData:
        with self.uow_factory(read_only=True) as uow:
            ...
            return TaskEditorData(
                ...
                tuple(uow.planning.plan_history(task_id)),

...
from overlord.application.common import ProjectDetail, TaskListItem
from overlord.domain.projects import Project, ProjectStatus
from overlord.domain.tasks import Task, TaskLifecycle
...
from overlord.presentation.pages.tasks import build_quick_task_dialog

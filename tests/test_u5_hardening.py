...
from overlord.ui.strings import ENGLISH_STRINGS, ui_text
...
class U5HardeningTests(unittest.TestCase):
    ...
    def test_theme_update_keeps_shell_mounted_and_shows_success(self):
        ...
        self.assertIn(ui_text("settings.saved"), _texts(app._shell.banner_host))
    ...
    def test_presentation_catalog_has_no_known_mojibake(self):
        ...
        self.assertEqual("Today", ui_text("dashboard.today.title"))

    def test_u5_visible_settings_copy_is_centralized(self):
        settings_source = (ROOT / "overlord" / "ui" / "pages" / "settings" / "page.py").read_text(encoding="utf-8")

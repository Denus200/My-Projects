...
from overlord.application.cycles import WeeklyOutcomeDraft
...
from overlord.presentation.state import AppSessionState, CycleFilterState, CycleWizardState
...
class U4CycleTests(unittest.TestCase):
    ...
    def test_cycles_page_is_browse_first_and_preserves_filters(self):
        ...
        self.assertEqual(ui_text("cycles.browse"), control.controls[1].content.controls[0].value)
    ...
    def test_wizard_cancel_creates_no_partial_records(self):
        ...
        control.controls[1].content.controls[-1].controls[0].on_click(None)
    ...
    def test_review_step_can_create_draft_without_partial_navigation(self):
        ...
        actions = control.controls[1].content.controls[-1]
    ...
    def test_weekly_outcome_edit_updates_only_selected_week(self):
        ...
        first_week_row = control.controls[3].content.controls[1]
    ...
    def test_cycle_detail_project_action_navigates_to_existing_project_route(self):
        ...
        connections = control.controls[4]
